    ...
    return ( 
        <>
            ...
            <div className='block text-center items-center justify-center mb-8 w-full'>
                <div className='flex items-center justify-center mb-4 lg:mb-2 w-full lg:w-auto mr-8'>
                    <img
                    ...
                    />
                    <p className="inline align-middle text-gray-700 ml-2 mb-4 font-medium text-lg">{post.author.name}</p>
                </div>
